...
<ComponentPreview
  ...
  openInV0Url="https://hodohoangkhang.github.io/r/wheel-picker.json"
/>

## Features

Built on top of [React Wheel Picker](https://www.npmjs.com/package/@ncdai/react-wheel-picker).
...
```bash
npx shadcn@latest add @hoangkang/wheel-picker
```
...
```bash
npm install @hoangkang/react-wheel-picker clsx tailwind-merge
```
...
See the [React Wheel Picker](https://www.npmjs.com/package/@ncdai/react-wheel-picker) package for more information.
